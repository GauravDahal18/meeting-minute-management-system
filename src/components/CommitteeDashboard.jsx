...
const CommitteeDashboard = () => {
  ...
  const sortCommitteesByName = () => {
    setCommittees((prev) =>
      [...prev].sort((a, b) => a.committeeName.localeCompare(b.committeeName))
    );
    setShowSortOptions(false);
  };
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center text-gray-600">Loading committees...</div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center bg-white p-6 rounded-lg shadow border">
          ...
          <div className="font-semibold mb-1">Error Loading Committees</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-white border rounded shadow p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xs text-gray-500">Total Committees</div>
